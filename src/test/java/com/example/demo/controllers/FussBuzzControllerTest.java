...
class FussBuzzControllerTest {
    ...
    void testCase21() throws UnsupportedEncodingException {
        String output = restTemplate.getForObject("/fuzzbuzz/" + URLEncoder.encode("2#", "UTF-8"), String.class);
        assertEquals("Invalid integer", output);
    }
